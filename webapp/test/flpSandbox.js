		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Locadora de Filmes Online",
									"targetURL": "#locadorasapprojetolocadorafiori-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"locadorasapprojetolocadorafiori-display": {
								"semanticObject": "locadorasapprojetolocadorafiori",
								"action": "display",
								"description": "Locadora de Filmes Online",
								"title": "Locadora de Filmes Online",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=locadora.sap.projetolocadorafiori",
									"url": sap.ui.require.toUrl("locadora/sap/projetolocadorafiori")
								}
							}
						}
					}
